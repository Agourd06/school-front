...
const CoursesSection: React.FC = () => {
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      setAlert({ type: 'success', message: t('messages.courseDeletedSuccessfully') });
      refetchCourses();
    } catch (err: unknown) {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div className="md:col-span-2">
            ...
            <input
              ...
              placeholder={t('sections.searchByCourseTitle')}
                ...
                courses.map((course) => {
                  ...
                  return (
                    <tr key={course.id} className="transition-colors hover:bg-gray-50/50">
                      ...
                      <td className="px-4 py-3 text-sm text-gray-700">
                        <PdfActions pdfPath={course.pdf_file} fileName={course.title} />
                      </td>
